export default {  
  ...
  portfolio: {
    ...
    liveLink: 'https://ramraphael.github.io',
    sourceLink: 'https://github.com/ramraphael/ramraphael.github.io',
    technologies: ['React', 'SASS'],
    description: `This portfolio was designed and built from scratch, using 
    React and a little SASS magic.`
  },
  ribbitjs: {
    title: 'RibbitJS',
    liveLink: '',
